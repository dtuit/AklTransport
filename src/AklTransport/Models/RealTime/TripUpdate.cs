namespace AklTransport.Models.RealTime
{
    ...
    public partial class TripUpdate : global::ProtoBuf.IExtensible
    {
        ...
        private readonly global::System.Collections.Generic.List<StopTimeUpdate> _stop_time_update = new global::System.Collections.Generic.List<StopTimeUpdate>();
        [global::ProtoBuf.ProtoMember(2, Name = @"stop_time_update", DataFormat = global::ProtoBuf.DataFormat.Default)]
        public global::System.Collections.Generic.List<StopTimeUpdate> stop_time_update
        {
