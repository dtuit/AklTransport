namespace AklTransport.Models.RealTime
{
    ...
    public partial class TranslatedString : global::ProtoBuf.IExtensible
    {
        ...
        private readonly global::System.Collections.Generic.List<Translation> _translation = new global::System.Collections.Generic.List<Translation>();
        [global::ProtoBuf.ProtoMember(1, Name = @"translation", DataFormat = global::ProtoBuf.DataFormat.Default)]
        public global::System.Collections.Generic.List<Translation> translation
        {
